...
var TransactionSystem = (function () {
    function TransactionSystem(systemConfig, DbConnection) {
        ...
        this.getOrderDate = function () {
            ...
            if (parseInt(moment(_this.currentSysTime).format("MM"), 10) === _this.randomDeclineMonth) {
                dayFactor = dayFactor / _this.randomDeclineMonth;
            }
            if (_this.currentSysTime.getTime() < Date.now())
                _this.currentSysTime = new Date(_this.currentSysTime.getTime() + (utils_1.generateRandomInt(60000, 300000) * 100 / dayFactor));
            else
        ...
        this.randomDeclineMonth = utils_1.generateRandomInt(1, 12);
    }
