...
transactionSystem.orderReceived$()
    ...
    .subscribe(function (transaction) { return console.log(transaction.order.status, transaction.order.orderId, transaction.order.timestamp); }, null, function () { return console.log("complete"); });
